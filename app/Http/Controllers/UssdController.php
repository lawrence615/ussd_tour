...
//				exit;
    ...
    {
        /**
         * a response that requires a user input starts with CON
         *
         * a response that does not requires a user input starts with END
         */
        if ($type == 1) {
            $output = "CON ";
     ...
     * @return bool
     *
     * you can have your custom logic here
     */
